    ...
    <Dialog open={open} onOpenChange={() => {}}>
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-hidden flex flex-col">
        ...
        <div className="flex-1 overflow-hidden">
          <Tabs defaultValue="termos" className="w-full h-full flex flex-col">
            ...
            <TabsContent value="termos" className="flex-1 overflow-hidden">
              <ScrollArea className="h-[50vh] md:h-[400px] w-full rounded-md border p-4">
            ...
            <TabsContent value="privacidade" className="flex-1 overflow-hidden">
              <ScrollArea className="h-[50vh] md:h-[400px] w-full rounded-md border p-4">
                <div className="space-y-4 text-sm">
