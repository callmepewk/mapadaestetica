    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button
          variant="outline"
          size="sm"
          className="border-2 border-orange-400 text-orange-700 hover:bg-orange-50 font-semibold h-8 px-2 text-xs"
        >
          <Eye className="w-3 h-3 sm:w-4 sm:h-4 mr-1" />
          <IconeAtual className="w-3 h-3 sm:w-4 sm:h-4 mx-0.5" />
          <span className="hidden lg:inline text-xs">{visaoAtualData?.label}</span>
        </Button>
      </DropdownMenuTrigger>
