  ...
  return (
    <section className="py-8 bg-white">
      <div className="max-w-7xl mx-auto px-4">
        <h1 className="text-2xl md:text-3xl font-bold mb-2 capitalize">Tratamento: {termo}</h1>
        <p className="text-sm text-gray-600 mb-4">Profissionais e clínicas relacionados</p>
        {anuncios.length === 0 ? (
          <Card className="border-dashed"><CardContent className="p-6 text-gray-600">Nenhum anúncio encontrado para este tratamento.</CardContent></Card>
        ) : (
